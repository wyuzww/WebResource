...
-- Records of collect
-- ----------------------------
INSERT INTO `collect` VALUES ('student1', '1');
INSERT INTO `collect` VALUES ('student1', '2');
...
-- Records of comment
-- ----------------------------
INSERT INTO `comment` VALUES ('1', '1', 'student1', '我是评论！', '2019-01-05');
INSERT INTO `comment` VALUES ('3', '1', 'student1', '我是评论啊！！！', '2019-01-06');
...
INSERT INTO `follow` VALUES ('teacher1', 'student1');
...
-- Records of post
-- ----------------------------
INSERT INTO `post` VALUES ('1', 'teacher1', '第一个帖子', '第一个帖子，第一个帖子，第一个帖子，第一个帖子，第一个帖子，第一个帖子，第一个帖子，第一个帖子，第一个帖子，第一个帖子，第一个帖子，第一个帖子，第一个帖子，第一个帖子。', 'upload/images/image.jpg', '2019-01-05');
...
CREATE TABLE `resource` (
  ...
  CONSTRAINT `resource_ibfk_2` FOREIGN KEY (`resource_uid`) REFERENCES `user` (`user_id`) ON DELETE NO ACTION ON UPDATE CASCADE
...
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES ('student1', 'student1', '女', '2019-01-05', '160803', '我是student1！我是student1！我是student1！我是student1！我是student1！');
...
-- Records of teacher
-- ----------------------------
INSERT INTO `teacher` VALUES ('teacher1', 'teacher1', '男', '2019-01-05', '我是teacher1！我是teacher1！我是teacher1！我是teacher1！我是teacher1！');
