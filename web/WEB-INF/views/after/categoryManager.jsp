    ...
    <script type="text/javascript">
        ...
        function deleteCategory() {
            ...
            $.messager.confirm("系统提示", "您确认要删掉这<font color=red>" + selectedRows.length + "</font>条数据吗？", function (r) {
                if (r) {
                    $.post("category", {delIds: ids, flagText: "delete"}, function (result) {
        ...
        function searchCategory() {
            $('#dg').datagrid('load', {
                category_name: $('#f_category_name').val(),
            });
        }
        ...
        function openUpdateCategoryDialog() {
            ...
            url = "category?flagText=update&category_id=" + row.category_id;
        }
    </script>
</head>
<body>
<table id="dg" title="管理资源类别" class="easyui-datagrid" fitColumns="true"
       pagination="true" url="category?flagText=allCategory" fit="true" toolbar="#tb" .>
    <thead>
    <tr>
