...
<head>
    ...
    <script type="text/javascript">
        ...
        function openAddTeacherDialog() {
            ...
            resetValue();
            url = "teacher?flagText=addTeacher";
        }
        ...
        function saveUser() {
            $("#fm").form("submit", {
                url: url,
                onSubmit: function () {
                    if ($('#user_id').val() == "" || $('#user_password').val() == "" || $('#teacher_name').val() == "") {
...
<body>
<table id="dg" title="管理教师帐号" class="easyui-datagrid" fitColumns="true"
       pagination="true" rownumbers="true" url="teacher?flagText=allTeacher" fit="true" toolbar="#tb" .>
    <thead>
    <tr>
        <th field="cb" checkbox="true"></th>
        <th field="user_id" width="100" align="center">帐号</th>
        <th field="user_password" width="100" align="center">密码</th>
        <th field="teacher_name" width="100" align="center">姓名</th>
        <th field="teacher_sex" width="50" align="center">性别</th>
        <th field="teacher_birth" width="100" align="center">生日</th>
        <th field="teacher_desc" width="150" align="center">个人说明</th>
...
<div id="tb" align="center">
    <div>
        <a href="javascript:openAddTeacherDialog()" class="easyui-linkbutton" iconCls="icon-add" plain="true">添加</a>
