    ...
    <script type="text/javascript">
        ...
        function deleteResource() {
            ...
            $.messager.confirm("系统提示", "您确认要删掉这<font color=red>" + selectedRows.length + "</font>个资源吗？", function (r) {
                if (r) {
                    $.post("Resource", {delIds: ids, flagText: "delete"}, function (result) {
        ...
        function setGood() {
            ...
            $.messager.confirm("系统提示", "您确认要标优这<font color=red>" + selectedRows.length + "</font>个资源吗？", function (r) {
                if (r) {
                    $.post("Resource", {delIds: ids, flagText: "update"}, function (result) {
                        // var json = $.parseJSON(result);
                        if (result.success == "true") {
        ...
        function searchResource() {
            $('#dg').datagrid('load', {
                resource_name: $('#f_resource_name').val(),
                user_level: $('#f_user_level').combobox("getValue"),
                resource_cid: $('#f_resource_cid').combobox("getValue")
            });
        }
...
<body>
<table id="dg" title="管理资源信息" class="easyui-datagrid" fitColumns="true"
       pagination="true" url="Resource?flagText=allResource" fit="true" toolbar="#tb" .>
    <thead>
    <tr>
        ...
        <th field="category_name" width="50" align="center">资源类别</th>
        <th field="resource_level" width="50" align="center">资源等级</th>
        <th field="resource_uid" width="50" align="center">作者</th>
...
<div id="tb" align="center">
    ...
    <div>
        ...
        &nbsp;资源类别：&nbsp;<input class="easyui-combobox" name="f_resource_cid" id="f_resource_cid" size="20"
                              data-options="panelHeight:'auto',editable:false,valueField:'category_id',textField:'category_name',url:'category?flagText=allCategoryList'"/>
        &nbsp;作者类别：&nbsp;
