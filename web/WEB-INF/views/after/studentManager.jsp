...
<head>
    ...
    <script type="text/javascript">
        ...
        function openAddStudentDialog() {
            ...
            resetValue();
            url = "student?flagText=addStudent";
        }
...
<table id="dg" title="管理学生帐号" class="easyui-datagrid" fitColumns="true"
       pagination="true" rownumbers="true" url="student?flagText=allStudent" fit="true" toolbar="#tb" .>
    <thead>
    <tr>
        ...
        <th field="student_sex" width="50" align="center">性别</th>
        <th field="student_birth" width="100" align="center">生日</th>
        <th field="student_class" width="50" align="center">班级</th>
        <th field="student_desc" width="150" align="center">个人说明</th>
...
<div id="dlg" class="easyui-dialog" style="width: 570px;height: 250px;padding: 10px 20px"
    ...
    <form id="fm" method="post">
        <table cellspacing="5px;">
            ...
            <tr>
                <td>姓名：</td>
                <td><input type="text" name="student_name" id="student_name" class="easyui-validatebox"
                           required="true"/></td>
                <td>班级：</td>
                <td><input type="text" name="student_class" id="student_class" class="easyui-validatebox"
                           required="true"/></td>
            </tr>
        </table>
    </form>
