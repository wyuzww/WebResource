...
<%
    ...
    if (StringUtil.isNotEmpty(flag) && flag.equals("delete")) {
        ...
        resource.setResource_id(Integer.parseInt(rid));
        resource.setResource_uid(uid);
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <ul class="clearfix">
                ...
                <li style="display:block">
                    <a class="list-group-item active" title="我的资源" href="user/user_resource?uid=${currentUser.user_id}">我的资源</a>
                </li>
                <li style="display:block">
            ...
            <div class="panel panel-default ">
                <div class="container-fluid">
                    <div style="margin: 20px">
                        <form class=" form-inline" action="user/user_resource?uid=${currentUser.user_id}" method="GET" id="form-search">
                                    ...
                                    <a href="resource/resource_details?rid=${all_resource.resource_id}" title="${all_resource.resource_name}" class="list-group-item">
                                        <h4 class="list-group-item-heading">${all_resource.resource_name}
                                            ...
                                            <div class="navbar-right" style="margin-right: 10px">
                                                    <button title="删除资源" class="btn btn-danger btn-sm" onclick="window.location='user/user_resource?flag=delete&uid=${currentUser.user_id}&rid=${all_resource.resource_id}';return false" >删除资源
                                                </button>
                                            </div>
                                        </h4>
